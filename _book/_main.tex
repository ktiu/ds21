...
21. Juni 2021 & 23 & \protect\hyperlink{statistische-analyseverfahren}{Statistische Analyseverfahren} \\
...
\hypertarget{statistische-analyseverfahren}{%
\section{Statistische Analyseverfahren}\label{statistische-analyseverfahren}}
...
\tightlist
\item
  Korrelation und mit \texttt{cor()} und Korrelationstest \texttt{cor.test()}
\item
  \(t\)-Test mit \texttt{t.test()} (1- und 2-Stichproben-Varianten)
\item
  \(F\)-Test mit \texttt{var.test()}
\end{itemize}

\hypertarget{text-beer-2016}{%
\section{Text: Beer 2016}\label{text-beer-2016}}

\hypertarget{lesetext-5}{%
\subsubsection{Lesetext}\label{lesetext-5}}

Beer, David. 2016. Measurement. In: \emph{Metric Power.} London: Palgrave Macmillan. S.~37--75.

Daraus: Seiten 37 -- 60

\hypertarget{fragen-an-den-text-6}{%
\subsubsection{Fragen an den Text:}\label{fragen-an-den-text-6}}

\hypertarget{fragen-an-den-text-7}{%
\subsubsection{Fragen an den Text}\label{fragen-an-den-text-7}}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Wie ging es Ihnen mit dem Text? Was war vielleicht schwierig? Wie sind Sie damit umgegangen?
\item
  Um welche Art von Text handelt es sich? In welcher Form und wo ist er erschienen, wer ist der Autor, und an wen wendet er sich?
\item
  Was ist das zentrale Anliegen des Texts? Wo genau steht das?
\item
  Welche theoretischen Referenzen werden herangezogen? Was davon kommt Ihnen bekannt vor? Was können Sie wie einordnen?
\item
  Welche Entwicklung im späten 18. und frühen 19. Jahrhundert wird beschrieben? Wie war die Welt vorher?
\item
  Welche Rolle spielen im Text die folgenden Beriffe?
  ...
  \end{itemize}
\item
  Finden Sie die Erzählung schlüssig? Was fehlt Ihnen?
\item
  Gibt es Momente in Ihrem Alltag, in denen Sie ``metric power'' erleben?
\end{enumerate}
