...
Der Operator `%>%` heisst „Pipe“ und setzt das Ergebnis der vorherigen Funktion als ersten Parameter in die nächste Funktion ein. Zur Veranschaulichung:
...
```{r include=show_solutions, warning=F, message=F}
...
```{r echo=show_solutions, cache=T, warning=F, message=F}
pleiades %>%
